...
import { CheckCircle2, Clock, MessageSquare, Flame } from 'lucide-react';
import Link from 'next/link';
import { buildWhatsAppClickToChatUrl } from '@/lib/whatsapp-link';
import { getLastOrder, type LocalOrder } from '@/lib/local-orders';
      ...
      <main className="pt-32 pb-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {loading ? (
          ...
          <div className="py-20 text-center text-[#9F9589] bg-[#1A1815] rounded-2xl border border-[#24201C]">
            <h1 className="font-serif text-2xl text-[#F4EBDD] mb-2">No Recent Order Found</h1>
            <p className="text-xs mb-6">
              We couldn&apos;t find a recent order on this device. Please place an order to see the
              confirmation here.
            </p>
            <Link
              href="/menu"
          ...
          <div className="space-y-8">
            ...
            <div className="p-8 rounded-3xl bg-[#1A1815] border border-[#C69A45]/30 text-center shadow-2xl space-y-4">
              ...
              <p className="font-sans text-[11px] text-[#9F9589] max-w-lg mx-auto">
                Please send the pre-filled WhatsApp message so our team can confirm your order and
                share live updates on your phone.
              </p>
            </div>
