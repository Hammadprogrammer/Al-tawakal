...
import { DEALS } from '@/data/static-data';
...
const deals: Deal[] = DEALS.filter((deal) => deal.isActive);

export function PublicDealsClient() {
                ...
                >
                  ...
                  <div>
                    <div className="relative aspect-[16/9] overflow-hidden bg-[#11100E]">
                      <img
                        src={deal.image}
                        alt={`${deal.title} - Tawakal BBQ Karachi Deal`}
